...
$(".error_message").hide(); // $('.caps_message').hide();
...
var idCompiler = function idCompiler() {
  var u_id = $("#u_id").val(); // isEmail(u_id);
...
var pwCompiler = function pwCompiler() {
  var u_pw = $("#u_pw").val();
  isPassword(u_pw);
...
$("#sj_submit").on("click", function () {
  var u_id = $("#u_id").val();
  var u_pw = $("#u_pw").val();
  console.log("u_id, u_pw", u_id, u_pw); // 값이 빈값일 때
